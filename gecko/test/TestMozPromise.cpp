...
class MOZ_STACK_CLASS PromiseAutoTaskQueue
{
public:
  PromiseAutoTaskQueue()
...
void Test_MozPromise()
{

  Test_MozPromiseBasicResolve();
  Test_MozPromiseBasicReject();
  Test_MozPromiseBasicResolveOrRejectResolved();
  Test_MozPromiseBasicResolveOrRejectRejected();
  Test_MozPromiseAsyncResolve();
  Test_MozPromiseCompletionPromises();
  Test_MozPromisePromiseAllResolve();
  Test_MozPromisePromiseAllReject();
  Test_MozPromiseChaining();
  Test_MozPromiseResolveOrRejectValue();
  Test_MozPromiseMoveOnlyType();
  Test_MozPromiseHeterogeneousChaining();
  Test_MozPromiseXPCOMEventTarget();
  // Test_MozPromiseMessageLoopEventTarget();
